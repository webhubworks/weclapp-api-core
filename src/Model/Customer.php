...
class Customer extends \ArrayObject
{
     ...
     * 
     *
     * @param string $customerRatingName
     *
     * @deprecated
     *
     * @return self
     ...
     * 
     *
     * @param list<Entity> $customerTopics
     *
     * @deprecated
     *
     * @return self
     ...
     * 
     *
     * @param string $defaultHeaderDiscount
     *
     * @return self
     */
     ...
     * 
     *
     * @param string $defaultHeaderSurcharge
     *
     * @return self
     */
     ...
     * 
     *
     * @param bool $useCustomsTariffNumber
     *
     * @return self
     */
