...
class StoragePlaceSize extends \ArrayObject
{
    /**
     * @var array
     */
    ...
    public function getSegmentQuantity(): int
    {
        return $this->segmentQuantity;
    }

    public function setSegmentQuantity(int $segmentQuantity): self
    {
        $this->initialized['segmentQuantity'] = true;
