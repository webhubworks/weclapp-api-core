...
class TicketAssignmentRule extends \ArrayObject
{
     ...
     * @return string|null
     */
    public function getBusinessHolidaysId(): ?string
    {
     ...
     * 
     *
     * @param string|null $businessHolidaysId
     *
     * @return self
     */
    public function setBusinessHolidaysId(?string $businessHolidaysId): self
    {
     ...
     * @return string|null
     */
    public function getBusinessHoursId(): ?string
    {
     ...
     * 
     *
     * @param string|null $businessHoursId
     *
     * @return self
     */
     ...
     * 
     *
     * @param list<OnlyId>|null $parties
     *
     * @return self
     */
