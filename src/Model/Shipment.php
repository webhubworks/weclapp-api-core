...
class Shipment extends \ArrayObject
{
     ...
     * @return string|null
     */
    public function getMainSalesOrderId(): ?string
    {
        return $this->mainSalesOrderId;
    }
    /**
     * 
     *
     * @param string|null $mainSalesOrderId
     *
     * @return self
     */
    public function setMainSalesOrderId(?string $mainSalesOrderId): self
    {
        $this->initialized['mainSalesOrderId'] = true;
        $this->mainSalesOrderId = $mainSalesOrderId;
        return $this;
    }
    /**
     * 
