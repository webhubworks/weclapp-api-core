...
class SalesInvoiceItem extends \ArrayObject
{
     ...
     * @deprecated
     *
     * @var list<SalesInvoiceItemRelationship>
     */
     ...
     * 
     *
     * @param string $cost2CostCenterId
     *
     * @return self
     */
     ...
     * 
     *
     * @param string $creditedInvoiceItemId
     *
     * @return self
     */
     ...
     * @deprecated
     *
     * @return list<SalesInvoiceItemRelationship>
     */
     ...
     * 
     *
     * @param list<SalesInvoiceItemRelationship> $salesInvoiceItemRelationship
     *
     * @deprecated
     *
     * @return self
