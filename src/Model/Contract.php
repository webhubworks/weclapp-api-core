...
class Contract extends \ArrayObject
{
     ...
     * @var string|null
     */
    protected $depositLocationId;
    /**
     * 
     *
     * @var string|null
     */
    protected $desiredSalesOrderStatus;
    /**
     * 
     *
     * @var bool|null
     ...
     * @var string|null
     */
    protected $technicalContactPersonId;
    /**
     * 
     *
     * @var bool|null
     ...
     * @return string|null
     */
    public function getDepositLocationId(): ?string
    {
        return $this->depositLocationId;
    }
    /**
     * 
     *
     * @param string|null $depositLocationId
     *
     * @return self
     */
    public function setDepositLocationId(?string $depositLocationId): self
    {
        $this->initialized['depositLocationId'] = true;
        $this->depositLocationId = $depositLocationId;
        return $this;
    }
    /**
     * 
     ...
     * @return string|null
     */
    public function getDesiredSalesOrderStatus(): ?string
    {
        return $this->desiredSalesOrderStatus;
    }
    /**
     * 
     *
     * @param string|null $desiredSalesOrderStatus
     *
     * @return self
     */
    public function setDesiredSalesOrderStatus(?string $desiredSalesOrderStatus): self
    {
        $this->initialized['desiredSalesOrderStatus'] = true;
        $this->desiredSalesOrderStatus = $desiredSalesOrderStatus;
        return $this;
    }
    /**
     * 
     ...
     * @return string|null
     */
    public function getFormVariantId(): ?string
    {
        return $this->formVariantId;
    }
    /**
     * 
     *
     * @param string|null $formVariantId
     *
     * @return self
     */
    public function setFormVariantId(?string $formVariantId): self
    {
        $this->initialized['formVariantId'] = true;
        $this->formVariantId = $formVariantId;
        return $this;
    }
    /**
     * 
     ...
     * @return string|null
     */
    public function getTechnicalContactPersonId(): ?string
    {
        return $this->technicalContactPersonId;
    }
    /**
     * 
     *
     * @param string|null $technicalContactPersonId
     *
     * @return self
     */
    public function setTechnicalContactPersonId(?string $technicalContactPersonId): self
    {
        $this->initialized['technicalContactPersonId'] = true;
