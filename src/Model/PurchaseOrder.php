...
class PurchaseOrder extends \ArrayObject
{
     ...
     * 
     *
     * @param string $commercialLanguageCustomer
     *
     * @return self
     */
     ...
     * 
     *
     * @param string $externalPurchaseOrderNumber
     *
     * @return self
     */
     ...
     * 
     *
     * @param string $formSettingsFromSalesChannel
     *
     * @return self
     */
     ...
     * 
     *
     * @param string $purchaseOrderRequestId
     *
     * @return self
     */
     ...
     * 
     *
     * @param string $purchaseOrderType
     *
     * @return self
     */
