...
class PutArticleCategoryClassificationIdById extends \Weclapp\Generated\Runtime\Client\BaseEndpoint implements \Weclapp\Generated\Runtime\Client\Endpoint
{
    protected $id;
     ...
     *           }
     */
    public function __construct(string $id, \Weclapp\Generated\Model\CustomValue $requestBody, array $queryParameters = [])
    {
        $this->id = $id;
