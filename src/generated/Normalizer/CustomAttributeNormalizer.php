...
class CustomAttributeNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    ...
    {
        return $type === \Weclapp\Generated\Model\CustomAttribute::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Weclapp\Generated\Model\CustomAttribute::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Weclapp\Generated\Model\CustomAttribute;
        ...
        if (\array_key_exists('entityReferences', $data)) {
            ...
            foreach ($data['entityReferences'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Weclapp\Generated\Model\EntityReference::class, 'json', $context);
            }
        ...
        if (\array_key_exists('selectedValues', $data)) {
            ...
            foreach ($data['selectedValues'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, \Weclapp\Generated\Model\OnlyId::class, 'json', $context);
            }
    ...
    {
        return [\Weclapp\Generated\Model\CustomAttribute::class => false];
    }
}
