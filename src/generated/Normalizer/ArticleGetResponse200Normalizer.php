...
class ArticleGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Weclapp\Generated\Model\ArticleGetResponse200::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Weclapp\Generated\Model\ArticleGetResponse200::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Weclapp\Generated\Model\ArticleGetResponse200();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('additionalProperties', $data)) {
            $object->setAdditionalProperties($this->denormalizer->denormalize($data['additionalProperties'], \Weclapp\Generated\Model\ArticleGetResponse200AdditionalProperties::class, 'json', $context));
    ...
    {
        return [\Weclapp\Generated\Model\ArticleGetResponse200::class => false];
    }
}