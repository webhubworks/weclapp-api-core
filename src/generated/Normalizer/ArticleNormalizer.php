...
class ArticleNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Weclapp\Generated\Model\Article::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Weclapp\Generated\Model\Article::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Weclapp\Generated\Model\Article();
        ...
        if (\array_key_exists('articleAlternativeQuantities', $data)) {
            ...
            foreach ($data['articleAlternativeQuantities'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, \Weclapp\Generated\Model\ArticleAlternativeQuantity::class, 'json', $context);
            }
        ...
        if (\array_key_exists('articleCalculationPrices', $data)) {
            ...
            foreach ($data['articleCalculationPrices'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, \Weclapp\Generated\Model\ArticleCalculationPrice::class, 'json', $context);
            }
        ...
        if (\array_key_exists('articleImages', $data)) {
            ...
            foreach ($data['articleImages'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, \Weclapp\Generated\Model\ArticleImage::class, 'json', $context);
            }
        ...
        if (\array_key_exists('articlePrices', $data)) {
            ...
            foreach ($data['articlePrices'] as $value_4) {
                $values_4[] = $this->denormalizer->denormalize($value_4, \Weclapp\Generated\Model\ArticlePriceWithoutArticleReference::class, 'json', $context);
            }
        ...
        if (\array_key_exists('customerArticleNumbers', $data)) {
            ...
            foreach ($data['customerArticleNumbers'] as $value_6) {
                $values_6[] = $this->denormalizer->denormalize($value_6, \Weclapp\Generated\Model\CustomerSpecificArticleAttributes::class, 'json', $context);
            }
        ...
        if (\array_key_exists('defaultStoragePlaces', $data)) {
            ...
            foreach ($data['defaultStoragePlaces'] as $value_7) {
                $values_7[] = $this->denormalizer->denormalize($value_7, \Weclapp\Generated\Model\OnlyId::class, 'json', $context);
            }
        ...
        if (\array_key_exists('priceCalculationParameters', $data)) {
            ...
            foreach ($data['priceCalculationParameters'] as $value_8) {
                $values_8[] = $this->denormalizer->denormalize($value_8, \Weclapp\Generated\Model\PriceCalculationParameterV1::class, 'json', $context);
            }
        ...
        if (\array_key_exists('productionBillOfMaterialItems', $data)) {
            ...
            foreach ($data['productionBillOfMaterialItems'] as $value_9) {
                $values_9[] = $this->denormalizer->denormalize($value_9, \Weclapp\Generated\Model\BillOfMaterial::class, 'json', $context);
            }
        ...
        if (\array_key_exists('quantityConversions', $data)) {
            ...
            foreach ($data['quantityConversions'] as $value_10) {
                $values_10[] = $this->denormalizer->denormalize($value_10, \Weclapp\Generated\Model\QuantityConversion::class, 'json', $context);
            }
        ...
        if (\array_key_exists('salesBillOfMaterialItems', $data)) {
            ...
            foreach ($data['salesBillOfMaterialItems'] as $value_11) {
                $values_11[] = $this->denormalizer->denormalize($value_11, \Weclapp\Generated\Model\SalesBillOfMaterialArticleItem::class, 'json', $context);
            }
        ...
        if (\array_key_exists('supplySources', $data)) {
            ...
            foreach ($data['supplySources'] as $value_12) {
                $values_12[] = $this->denormalizer->denormalize($value_12, \Weclapp\Generated\Model\SupplySource::class, 'json', $context);
            }
    ...
    {
        return [\Weclapp\Generated\Model\Article::class => false];
    }
}