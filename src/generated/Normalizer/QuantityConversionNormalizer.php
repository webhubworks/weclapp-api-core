...
class QuantityConversionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Weclapp\Generated\Model\QuantityConversion::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Weclapp\Generated\Model\QuantityConversion::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Weclapp\Generated\Model\QuantityConversion();
    ...
    {
        return [\Weclapp\Generated\Model\QuantityConversion::class => false];
    }
}