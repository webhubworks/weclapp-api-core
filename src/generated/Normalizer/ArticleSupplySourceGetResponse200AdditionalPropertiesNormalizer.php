...
class ArticleSupplySourceGetResponse200AdditionalPropertiesNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    ...
    {
        return $type === \Weclapp\Generated\Model\ArticleSupplySourceGetResponse200AdditionalProperties::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Weclapp\Generated\Model\ArticleSupplySourceGetResponse200AdditionalProperties::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Weclapp\Generated\Model\ArticleSupplySourceGetResponse200AdditionalProperties;
        ...
        if (\array_key_exists('currentPurchasePrice', $data)) {
            ...
            foreach ($data['currentPurchasePrice'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Weclapp\Generated\Model\PriceData::class, 'json', $context);
            }
        ...
        if (\array_key_exists('currentPurchasePriceInCompanyCurrency', $data)) {
            ...
            foreach ($data['currentPurchasePriceInCompanyCurrency'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, \Weclapp\Generated\Model\Amount::class, 'json', $context);
            }
    ...
    {
        return [\Weclapp\Generated\Model\ArticleSupplySourceGetResponse200AdditionalProperties::class => false];
    }
}
