...
class GetSalesOrderDefaultValuesForCreate extends \Webhubworks\WeclappApiCore\Runtime\Client\BaseEndpoint implements \Webhubworks\WeclappApiCore\Runtime\Client\Endpoint
{
    ...
    protected function getQueryOptionsResolver(): \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setDefined(['customerId', 'responsibleUserId']);
        $optionsResolver->setRequired(['customerId']);
     ...
     *
     *
     * @return null|\Webhubworks\WeclappApiCore\Model\SalesOrderDefaultValuesForCreateGetResponse200|\Webhubworks\WeclappApiCore\Model\ApiProblem
     */
