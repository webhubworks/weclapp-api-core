...
class PutIncomingGoodsIdById extends \Webhubworks\WeclappApiCore\Runtime\Client\BaseEndpoint implements \Webhubworks\WeclappApiCore\Runtime\Client\Endpoint
{
    protected $id;
    /**
     ...
     * }
     */
    public function __construct(string $id, ?\Webhubworks\WeclappApiCore\Model\IncomingGoods $requestBody = null, array $queryParameters = [])
    {
        $this->id = $id;
    ...
    {
        return str_replace(['{id}'], [$this->id], '/incomingGoods/id/{id}');
    }
