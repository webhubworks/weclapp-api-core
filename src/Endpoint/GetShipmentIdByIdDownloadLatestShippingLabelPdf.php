...
class GetShipmentIdByIdDownloadLatestShippingLabelPdf extends \Webhubworks\WeclappApiCore\Runtime\Client\BaseEndpoint implements \Webhubworks\WeclappApiCore\Runtime\Client\Endpoint
{
    protected $id;
    ...
    {
        return str_replace(['{id}'], [$this->id], '/shipment/id/{id}/downloadLatestShippingLabelPdf');
    }
