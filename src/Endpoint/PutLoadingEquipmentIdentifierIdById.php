...
class PutLoadingEquipmentIdentifierIdById extends \Webhubworks\WeclappApiCore\Runtime\Client\BaseEndpoint implements \Webhubworks\WeclappApiCore\Runtime\Client\Endpoint
{
    protected $id;
    /**
     ...
     * }
     */
    public function __construct(string $id, \Webhubworks\WeclappApiCore\Model\LoadingEquipmentIdentifier $requestBody, array $queryParameters = [])
    {
        $this->id = $id;
    ...
    {
        return str_replace(['{id}'], [$this->id], '/loadingEquipmentIdentifier/id/{id}');
    }
