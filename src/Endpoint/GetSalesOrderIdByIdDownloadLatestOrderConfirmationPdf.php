...
class GetSalesOrderIdByIdDownloadLatestOrderConfirmationPdf extends \Webhubworks\WeclappApiCore\Runtime\Client\BaseEndpoint implements \Webhubworks\WeclappApiCore\Runtime\Client\Endpoint
{
    protected $id;
    protected $accept;
    /**
    ...
    {
        return str_replace(['{id}'], [$this->id], '/salesOrder/id/{id}/downloadLatestOrderConfirmationPdf');
    }
