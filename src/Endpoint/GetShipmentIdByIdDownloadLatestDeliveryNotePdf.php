...
class GetShipmentIdByIdDownloadLatestDeliveryNotePdf extends \Webhubworks\WeclappApiCore\Runtime\Client\BaseEndpoint implements \Webhubworks\WeclappApiCore\Runtime\Client\Endpoint
{
    protected $id;
    protected $accept;
    /**
    ...
    {
        return str_replace(['{id}'], [$this->id], '/shipment/id/{id}/downloadLatestDeliveryNotePdf');
    }
