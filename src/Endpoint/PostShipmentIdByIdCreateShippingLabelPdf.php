...
class PostShipmentIdByIdCreateShippingLabelPdf extends \Webhubworks\WeclappApiCore\Runtime\Client\BaseEndpoint implements \Webhubworks\WeclappApiCore\Runtime\Client\Endpoint
{
    ...
    protected function getQueryOptionsResolver(): \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setDefined(['name', 'description']);
     ...
     *
     *
     * @return null|\Webhubworks\WeclappApiCore\Model\ShipmentIdIdCreateShippingLabelPdfPostResponse200|\Webhubworks\WeclappApiCore\Model\ApiProblem
     */
