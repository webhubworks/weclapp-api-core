...
class GetProductionOrderIdByIdDownloadLatestProductionOrderPdf extends \Webhubworks\WeclappApiCore\Runtime\Client\BaseEndpoint implements \Webhubworks\WeclappApiCore\Runtime\Client\Endpoint
{
    protected $id;
    ...
    {
        return str_replace(['{id}'], [$this->id], '/productionOrder/id/{id}/downloadLatestProductionOrderPdf');
    }
