...
class PutTaxDeterminationRuleIdById extends \Webhubworks\WeclappApiCore\Runtime\Client\BaseEndpoint implements \Webhubworks\WeclappApiCore\Runtime\Client\Endpoint
{
    protected $id;
    /**
     ...
     * }
     */
    public function __construct(string $id, ?\Webhubworks\WeclappApiCore\Model\TaxDeterminationRule $requestBody = null, array $queryParameters = [])
    {
        $this->id = $id;
    ...
    {
        return str_replace(['{id}'], [$this->id], '/taxDeterminationRule/id/{id}');
    }
