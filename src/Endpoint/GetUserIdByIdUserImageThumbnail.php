...
class GetUserIdByIdUserImageThumbnail extends \Webhubworks\WeclappApiCore\Runtime\Client\BaseEndpoint implements \Webhubworks\WeclappApiCore\Runtime\Client\Endpoint
{
    protected $id;
    ...
    {
        return str_replace(['{id}'], [$this->id], '/user/id/{id}/userImageThumbnail');
    }
