...
class PostArticleIdByIdChangeUnit extends \Webhubworks\WeclappApiCore\Runtime\Client\BaseEndpoint implements \Webhubworks\WeclappApiCore\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $id, ?\Webhubworks\WeclappApiCore\Model\ArticleIdIdChangeUnitPostBody $requestBody = null)
    {
        $this->id = $id;
     ...
     *
     *
     * @return null|\Webhubworks\WeclappApiCore\Model\ArticleIdIdChangeUnitPostResponse200|\Webhubworks\WeclappApiCore\Model\ApiProblem
     */
