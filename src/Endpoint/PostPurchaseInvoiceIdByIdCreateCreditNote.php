...
class PostPurchaseInvoiceIdByIdCreateCreditNote extends \Webhubworks\WeclappApiCore\Runtime\Client\BaseEndpoint implements \Webhubworks\WeclappApiCore\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $id, \Webhubworks\WeclappApiCore\Model\PurchaseInvoiceIdIdCreateCreditNotePostBody $requestBody)
    {
        $this->id = $id;
     ...
     *
     *
     * @return null|\Webhubworks\WeclappApiCore\Model\PurchaseInvoiceIdIdCreateCreditNotePostResponse200|\Webhubworks\WeclappApiCore\Model\ApiProblem
     */
