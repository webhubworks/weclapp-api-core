...
class PostBankAccount extends \Webhubworks\WeclappApiCore\Runtime\Client\BaseEndpoint implements \Webhubworks\WeclappApiCore\Runtime\Client\Endpoint
{
    /**
     ...
     * }
     */
    public function __construct(?\Webhubworks\WeclappApiCore\Model\BankAccount $requestBody = null, array $queryParameters = [])
    {
