...
class PutArticleSupplySourceIdById extends \Webhub\Weclapp\Runtime\Client\BaseEndpoint implements \Webhub\Weclapp\Runtime\Client\Endpoint
{
    protected $id;
     ...
     *           }
     */
    public function __construct(string $id, \Webhub\Weclapp\Model\ArticleSupplySource $requestBody, array $queryParameters = [])
    {
        $this->id = $id;
