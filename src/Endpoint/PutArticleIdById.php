...
class PutArticleIdById extends \Webhub\Weclapp\Runtime\Client\BaseEndpoint implements \Webhub\Weclapp\Runtime\Client\Endpoint
{
    protected $id;
     ...
     *           }
     */
    public function __construct(string $id, \Webhub\Weclapp\Model\Article $requestBody, array $queryParameters = [])
    {
        $this->id = $id;
