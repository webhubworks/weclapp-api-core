...
class PurchaseOpenItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('purchaseInvoiceId', $data) && $data['purchaseInvoiceId'] !== null) {
            $object->setPurchaseInvoiceId($data['purchaseInvoiceId']);
            unset($data['purchaseInvoiceId']);
        }
        elseif (\array_key_exists('purchaseInvoiceId', $data) && $data['purchaseInvoiceId'] === null) {
            $object->setPurchaseInvoiceId(null);
        }
