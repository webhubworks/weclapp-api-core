...
class SalesInvoiceItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('salesInvoiceItemRelationships', $data) && $data['salesInvoiceItemRelationships'] !== null) {
            $values_4 = [];
            foreach ($data['salesInvoiceItemRelationships'] as $value_4) {
            ...
            $object->setSalesInvoiceItemRelationships($values_4);
            unset($data['salesInvoiceItemRelationships']);
        }
        elseif (\array_key_exists('salesInvoiceItemRelationships', $data) && $data['salesInvoiceItemRelationships'] === null) {
            $object->setSalesInvoiceItemRelationships(null);
        }
