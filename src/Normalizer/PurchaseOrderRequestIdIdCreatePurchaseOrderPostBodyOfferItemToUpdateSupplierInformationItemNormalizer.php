...
class PurchaseOrderRequestIdIdCreatePurchaseOrderPostBodyOfferItemToUpdateSupplierInformationItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('createOrUpdateArticleSupplySource', $data) && $data['createOrUpdateArticleSupplySource'] !== null) {
        ...
        elseif (\array_key_exists('createOrUpdateArticleSupplySource', $data) && $data['createOrUpdateArticleSupplySource'] === null) {
            $object->setCreateOrUpdateArticleSupplySource(null);
        }
        ...
        if (\array_key_exists('updateInformation', $data) && $data['updateInformation'] !== null) {
            $object->setUpdateInformation($data['updateInformation']);
            unset($data['updateInformation']);
        }
        elseif (\array_key_exists('updateInformation', $data) && $data['updateInformation'] === null) {
            $object->setUpdateInformation(null);
        }
        if (\array_key_exists('updatePurchasePrice', $data) && $data['updatePurchasePrice'] !== null) {
            $object->setUpdatePurchasePrice($data['updatePurchasePrice']);
            unset($data['updatePurchasePrice']);
        }
        elseif (\array_key_exists('updatePurchasePrice', $data) && $data['updatePurchasePrice'] === null) {
            $object->setUpdatePurchasePrice(null);
        }
