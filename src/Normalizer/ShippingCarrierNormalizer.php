...
class ShippingCarrierNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('shippingServiceProviderType', $data)) {
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('ecommerceShippingCarrier') && $data->getEcommerceShippingCarrier() !== null) {
            $dataArray['ecommerceShippingCarrier'] = $data->getEcommerceShippingCarrier();
        }
        if ($data->isInitialized('internalShippingCarrier') && $data->getInternalShippingCarrier() !== null) {
        ...
        if ($data->isInitialized('shippingServiceProviderType') && $data->getShippingServiceProviderType() !== null) {
            $dataArray['shippingServiceProviderType'] = $data->getShippingServiceProviderType();
        }
        if ($data->isInitialized('trackingUrl') && $data->getTrackingUrl() !== null) {
