...
class CampaignParticipantNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === \Webhubworks\WeclappApiCore\Model\CampaignParticipant::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Webhubworks\WeclappApiCore\Model\CampaignParticipant::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Webhubworks\WeclappApiCore\Model\CampaignParticipant;
        if (\array_key_exists('participation', $data) && \is_int($data['participation'])) {
            $data['participation'] = (bool) $data['participation'];
        }
        ...
        if (\array_key_exists('participation', $data) && $data['participation'] !== null) {
            $object->setParticipation($data['participation']);
            unset($data['participation']);
        } elseif (\array_key_exists('participation', $data) && $data['participation'] === null) {
            $object->setParticipation(null);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('campaignId') && $data->getCampaignId() !== null) {
        ...
        if ($data->isInitialized('participation') && $data->getParticipation() !== null) {
            $dataArray['participation'] = $data->getParticipation();
        }
    ...
    {
        return [\Webhubworks\WeclappApiCore\Model\CampaignParticipant::class => false];
    }
}
