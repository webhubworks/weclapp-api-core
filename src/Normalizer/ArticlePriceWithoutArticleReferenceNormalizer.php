...
class ArticlePriceWithoutArticleReferenceNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    ...
    {
        return $type === \Webhub\Weclapp\Model\ArticlePriceWithoutArticleReference::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Webhub\Weclapp\Model\ArticlePriceWithoutArticleReference::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Webhub\Weclapp\Model\ArticlePriceWithoutArticleReference;
    ...
    {
        return [\Webhub\Weclapp\Model\ArticlePriceWithoutArticleReference::class => false];
    }
}
