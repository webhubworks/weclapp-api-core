...
class SupplierNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('customerNumberAtSupplier', $data) && $data['customerNumberAtSupplier'] !== null) {
            $object->setCustomerNumberAtSupplier($data['customerNumberAtSupplier']);
            unset($data['customerNumberAtSupplier']);
        } elseif (\array_key_exists('customerNumberAtSupplier', $data) && $data['customerNumberAtSupplier'] === null) {
            $object->setCustomerNumberAtSupplier(null);
        }
        ...
        if (\array_key_exists('orderBlock', $data) && $data['orderBlock'] !== null) {
            $object->setOrderBlock($data['orderBlock']);
            unset($data['orderBlock']);
        } elseif (\array_key_exists('orderBlock', $data) && $data['orderBlock'] === null) {
            $object->setOrderBlock(null);
        }
        ...
        if (\array_key_exists('supplierRatingId', $data) && $data['supplierRatingId'] !== null) {
            $object->setSupplierRatingId($data['supplierRatingId']);
            unset($data['supplierRatingId']);
        } elseif (\array_key_exists('supplierRatingId', $data) && $data['supplierRatingId'] === null) {
            $object->setSupplierRatingId(null);
        }
        if (\array_key_exists('supplierRatingName', $data) && $data['supplierRatingName'] !== null) {
            $object->setSupplierRatingName($data['supplierRatingName']);
            unset($data['supplierRatingName']);
        } elseif (\array_key_exists('supplierRatingName', $data) && $data['supplierRatingName'] === null) {
            $object->setSupplierRatingName(null);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('customerNumberAtSupplier') && $data->getCustomerNumberAtSupplier() !== null) {
        ...
        if ($data->isInitialized('orderBlock') && $data->getOrderBlock() !== null) {
        ...
        if ($data->isInitialized('supplierRatingId') && $data->getSupplierRatingId() !== null) {
            $dataArray['supplierRatingId'] = $data->getSupplierRatingId();
        }
        if ($data->isInitialized('supplierRatingName') && $data->getSupplierRatingName() !== null) {
