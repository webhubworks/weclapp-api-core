...
class VariantArticleVariantNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === \Webhubworks\WeclappApiCore\Model\VariantArticleVariant::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Webhubworks\WeclappApiCore\Model\VariantArticleVariant::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Webhubworks\WeclappApiCore\Model\VariantArticleVariant;
        ...
        if (\array_key_exists('attributeOptions', $data) && $data['attributeOptions'] !== null) {
            $values = [];
        ...
        } elseif (\array_key_exists('attributeOptions', $data) && $data['attributeOptions'] === null) {
            $object->setAttributeOptions(null);
        }
        ...
        if (\array_key_exists('variantArticleId', $data) && $data['variantArticleId'] !== null) {
            $object->setVariantArticleId($data['variantArticleId']);
            unset($data['variantArticleId']);
        } elseif (\array_key_exists('variantArticleId', $data) && $data['variantArticleId'] === null) {
            $object->setVariantArticleId(null);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('attributeOptions') && $data->getAttributeOptions() !== null) {
            $values = [];
        ...
        if ($data->isInitialized('variantArticleId') && $data->getVariantArticleId() !== null) {
            $dataArray['variantArticleId'] = $data->getVariantArticleId();
        }
    ...
    {
        return [\Webhubworks\WeclappApiCore\Model\VariantArticleVariant::class => false];
    }
}
