...
class ArticleSupplySourceGetResponse200AdditionalPropertiesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Webhub\Weclapp\Model\ArticleSupplySourceGetResponse200AdditionalProperties::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Webhub\Weclapp\Model\ArticleSupplySourceGetResponse200AdditionalProperties::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Webhub\Weclapp\Model\ArticleSupplySourceGetResponse200AdditionalProperties();
        ...
        if (\array_key_exists('currentPurchasePrice', $data)) {
            ...
            foreach ($data['currentPurchasePrice'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Webhub\Weclapp\Model\PriceData::class, 'json', $context);
            }
        ...
        if (\array_key_exists('currentPurchasePriceInCompanyCurrency', $data)) {
            ...
            foreach ($data['currentPurchasePriceInCompanyCurrency'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, \Webhub\Weclapp\Model\Amount::class, 'json', $context);
            }
    ...
    {
        return [\Webhub\Weclapp\Model\ArticleSupplySourceGetResponse200AdditionalProperties::class => false];
    }
}