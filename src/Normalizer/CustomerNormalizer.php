...
class CustomerNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('amountInsured', $data)) {
        ...
        if (\array_key_exists('blockNotice', $data)) {
        ...
        if (\array_key_exists('customerRatingId', $data)) {
            $object->setCustomerRatingId($data['customerRatingId']);
            unset($data['customerRatingId']);
        }
        if (\array_key_exists('customerRatingName', $data)) {
        ...
        if (\array_key_exists('customerTopics', $data)) {
            $values_7 = [];
        ...
        if (\array_key_exists('insolvent', $data)) {
        ...
        if (\array_key_exists('oldCustomerNumber', $data)) {
        ...
        if (\array_key_exists('satisfaction', $data)) {
            $object->setSatisfaction($data['satisfaction']);
            unset($data['satisfaction']);
        }
        if (\array_key_exists('useCustomsTariffNumber', $data)) {
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('amountInsured') && null !== $data->getAmountInsured()) {
        ...
        if ($data->isInitialized('blockNotice') && null !== $data->getBlockNotice()) {
            $dataArray['blockNotice'] = $data->getBlockNotice();
        }
        if ($data->isInitialized('blocked') && null !== $data->getBlocked()) {
        ...
        if ($data->isInitialized('customerRatingId') && null !== $data->getCustomerRatingId()) {
            $dataArray['customerRatingId'] = $data->getCustomerRatingId();
        }
        if ($data->isInitialized('customerRatingName') && null !== $data->getCustomerRatingName()) {
        ...
        if ($data->isInitialized('customerTopics') && null !== $data->getCustomerTopics()) {
            $values_7 = [];
        ...
        if ($data->isInitialized('defaultHeaderDiscount') && null !== $data->getDefaultHeaderDiscount()) {
            $dataArray['defaultHeaderDiscount'] = $data->getDefaultHeaderDiscount();
        }
        if ($data->isInitialized('defaultHeaderSurcharge') && null !== $data->getDefaultHeaderSurcharge()) {
            $dataArray['defaultHeaderSurcharge'] = $data->getDefaultHeaderSurcharge();
        }
        if ($data->isInitialized('deliveryBlock') && null !== $data->getDeliveryBlock()) {
            $dataArray['deliveryBlock'] = $data->getDeliveryBlock();
        }
        if ($data->isInitialized('description') && null !== $data->getDescription()) {
            $dataArray['description'] = $data->getDescription();
        }
        if ($data->isInitialized('insolvent') && null !== $data->getInsolvent()) {
            $dataArray['insolvent'] = $data->getInsolvent();
        }
        if ($data->isInitialized('insured') && null !== $data->getInsured()) {
        ...
        if ($data->isInitialized('oldCustomerNumber') && null !== $data->getOldCustomerNumber()) {
        ...
        if ($data->isInitialized('satisfaction') && null !== $data->getSatisfaction()) {
            $dataArray['satisfaction'] = $data->getSatisfaction();
        }
        if ($data->isInitialized('useCustomsTariffNumber') && null !== $data->getUseCustomsTariffNumber()) {
