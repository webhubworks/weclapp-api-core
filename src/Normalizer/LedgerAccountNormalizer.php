...
class LedgerAccountNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('automatic') && null !== $data->getAutomatic()) {
            $dataArray['automatic'] = $data->getAutomatic();
        }
        if ($data->isInitialized('balanceSheetItem') && null !== $data->getBalanceSheetItem()) {
            $dataArray['balanceSheetItem'] = $data->getBalanceSheetItem();
        }
        if ($data->isInitialized('description') && null !== $data->getDescription()) {
            $dataArray['description'] = $data->getDescription();
        }
        if ($data->isInitialized('parentAccountId') && null !== $data->getParentAccountId()) {
            $dataArray['parentAccountId'] = $data->getParentAccountId();
        }
        if ($data->isInitialized('parentAccountNumber') && null !== $data->getParentAccountNumber()) {
