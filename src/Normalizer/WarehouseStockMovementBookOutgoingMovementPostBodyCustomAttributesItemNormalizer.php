...
class WarehouseStockMovementBookOutgoingMovementPostBodyCustomAttributesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Webhubworks\WeclappApiCore\Model\WarehouseStockMovementBookOutgoingMovementPostBodyCustomAttributesItem::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Webhubworks\WeclappApiCore\Model\WarehouseStockMovementBookOutgoingMovementPostBodyCustomAttributesItem::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Webhubworks\WeclappApiCore\Model\WarehouseStockMovementBookOutgoingMovementPostBodyCustomAttributesItem();
    ...
    {
        return [\Webhubworks\WeclappApiCore\Model\WarehouseStockMovementBookOutgoingMovementPostBodyCustomAttributesItem::class => false];
    }
}