...
class WarehouseStockMovementBookOutgoingMovementPostBodyCustomAttributesItemNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
