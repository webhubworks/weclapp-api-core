...
class ArticleGetResponse200AdditionalPropertiesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('currentStockMinusTotalSalesVolume', $data) && $data['currentStockMinusTotalSalesVolume'] !== null) {
            $values_4 = [];
            foreach ($data['currentStockMinusTotalSalesVolume'] as $value_4) {
                $values_4[] = $value_4;
            }
            $object->setCurrentStockMinusTotalSalesVolume($values_4);
            unset($data['currentStockMinusTotalSalesVolume']);
        }
        elseif (\array_key_exists('currentStockMinusTotalSalesVolume', $data) && $data['currentStockMinusTotalSalesVolume'] === null) {
            $object->setCurrentStockMinusTotalSalesVolume(null);
        }
        if (\array_key_exists('pickableStockQuantity', $data) && $data['pickableStockQuantity'] !== null) {
            $values_5 = [];
            foreach ($data['pickableStockQuantity'] as $value_5) {
                $values_6 = [];
                foreach ($value_5 as $value_6) {
                    $values_6[] = $this->denormalizer->denormalize($value_6, \Webhubworks\WeclappApiCore\Model\WarehouseQuantity::class, 'json', $context);
                }
                $values_5[] = $values_6;
            }
            $object->setPickableStockQuantity($values_5);
        ...
        if (\array_key_exists('reservedStockQuantity', $data) && $data['reservedStockQuantity'] !== null) {
            $values_7 = [];
            foreach ($data['reservedStockQuantity'] as $value_7) {
                $values_8 = [];
                foreach ($value_7 as $value_8) {
                    $values_8[] = $this->denormalizer->denormalize($value_8, \Webhubworks\WeclappApiCore\Model\WarehouseQuantity::class, 'json', $context);
                }
                $values_7[] = $values_8;
            }
            $object->setReservedStockQuantity($values_7);
        ...
        if (\array_key_exists('totalStockQuantity', $data) && $data['totalStockQuantity'] !== null) {
            $values_9 = [];
            foreach ($data['totalStockQuantity'] as $value_9) {
                $values_10 = [];
                foreach ($value_9 as $value_10) {
                    $values_10[] = $this->denormalizer->denormalize($value_10, \Webhubworks\WeclappApiCore\Model\WarehouseQuantity::class, 'json', $context);
                }
                $values_9[] = $values_10;
            }
            $object->setTotalStockQuantity($values_9);
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('currentStockMinusTotalSalesVolume') && null !== $data->getCurrentStockMinusTotalSalesVolume()) {
            $values_4 = [];
            foreach ($data->getCurrentStockMinusTotalSalesVolume() as $value_4) {
                $values_4[] = $value_4;
            }
            $dataArray['currentStockMinusTotalSalesVolume'] = $values_4;
        }
        if ($data->isInitialized('pickableStockQuantity') && null !== $data->getPickableStockQuantity()) {
            $values_5 = [];
            foreach ($data->getPickableStockQuantity() as $value_5) {
                $values_6 = [];
                foreach ($value_5 as $value_6) {
            ...
            $dataArray['pickableStockQuantity'] = $values_5;
        }
        if ($data->isInitialized('reservedStockQuantity') && null !== $data->getReservedStockQuantity()) {
            $values_7 = [];
            foreach ($data->getReservedStockQuantity() as $value_7) {
                $values_8 = [];
                foreach ($value_7 as $value_8) {
            ...
            $dataArray['reservedStockQuantity'] = $values_7;
        }
        if ($data->isInitialized('totalStockQuantity') && null !== $data->getTotalStockQuantity()) {
            $values_9 = [];
            foreach ($data->getTotalStockQuantity() as $value_9) {
                $values_10 = [];
                foreach ($value_9 as $value_10) {
            ...
            $dataArray['totalStockQuantity'] = $values_9;
        }
        foreach ($data as $key => $value_11) {
            if (preg_match('/.*/', (string) $key)) {
