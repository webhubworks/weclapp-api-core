...
class WarehouseStockMovementBookDirectStockTransferPostBodyCustomAttributesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
