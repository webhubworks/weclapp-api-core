...
class EntityReferenceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Webhubworks\WeclappApiCore\Model\EntityReference::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Webhubworks\WeclappApiCore\Model\EntityReference::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Webhubworks\WeclappApiCore\Model\EntityReference();
    ...
    {
        return [\Webhubworks\WeclappApiCore\Model\EntityReference::class => false];
    }
}