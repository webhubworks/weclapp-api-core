...
class ArticlePriceWithoutSalesChannelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Webhub\Weclapp\Model\ArticlePriceWithoutSalesChannel::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Webhub\Weclapp\Model\ArticlePriceWithoutSalesChannel::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Webhub\Weclapp\Model\ArticlePriceWithoutSalesChannel();
    ...
    {
        return [\Webhub\Weclapp\Model\ArticlePriceWithoutSalesChannel::class => false];
    }
}