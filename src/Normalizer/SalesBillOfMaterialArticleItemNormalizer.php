...
class SalesBillOfMaterialArticleItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Webhub\Weclapp\Model\SalesBillOfMaterialArticleItem::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Webhub\Weclapp\Model\SalesBillOfMaterialArticleItem::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Webhub\Weclapp\Model\SalesBillOfMaterialArticleItem();
    ...
    {
        return [\Webhub\Weclapp\Model\SalesBillOfMaterialArticleItem::class => false];
    }
}