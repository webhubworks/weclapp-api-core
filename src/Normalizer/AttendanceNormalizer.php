...
class AttendanceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Webhubworks\WeclappApiCore\Model\Attendance::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Webhubworks\WeclappApiCore\Model\Attendance::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Webhubworks\WeclappApiCore\Model\Attendance();
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('endTime') && null !== $data->getEndTime()) {
            $dataArray['endTime'] = $data->getEndTime();
        }
    ...
    {
        return [\Webhubworks\WeclappApiCore\Model\Attendance::class => false];
    }
}