...
class PurchaseOrderItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('blanketPurchaseOrderReleaseId') && null !== $data->getBlanketPurchaseOrderReleaseId()) {
        ...
        if ($data->isInitialized('receivedQuantity') && null !== $data->getReceivedQuantity()) {
        ...
        if ($data->isInitialized('supplierArticleId') && null !== $data->getSupplierArticleId()) {
