...
class PurchaseOrderItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('articleSupplySourceId', $data) && $data['articleSupplySourceId'] !== null) {
            $object->setArticleSupplySourceId($data['articleSupplySourceId']);
            unset($data['articleSupplySourceId']);
        }
        elseif (\array_key_exists('articleSupplySourceId', $data) && $data['articleSupplySourceId'] === null) {
            $object->setArticleSupplySourceId(null);
        }
        if (\array_key_exists('batchSerialNumbers', $data) && $data['batchSerialNumbers'] !== null) {
            $values_2 = [];
        ...
        elseif (\array_key_exists('batchSerialNumbers', $data) && $data['batchSerialNumbers'] === null) {
            $object->setBatchSerialNumbers(null);
        }
        if (\array_key_exists('blanketPurchaseOrderId', $data) && $data['blanketPurchaseOrderId'] !== null) {
            $object->setBlanketPurchaseOrderId($data['blanketPurchaseOrderId']);
            unset($data['blanketPurchaseOrderId']);
        }
        elseif (\array_key_exists('blanketPurchaseOrderId', $data) && $data['blanketPurchaseOrderId'] === null) {
            $object->setBlanketPurchaseOrderId(null);
        }
        if (\array_key_exists('blanketPurchaseOrderReleaseId', $data) && $data['blanketPurchaseOrderReleaseId'] !== null) {
            $object->setBlanketPurchaseOrderReleaseId($data['blanketPurchaseOrderReleaseId']);
            unset($data['blanketPurchaseOrderReleaseId']);
        }
        elseif (\array_key_exists('blanketPurchaseOrderReleaseId', $data) && $data['blanketPurchaseOrderReleaseId'] === null) {
            $object->setBlanketPurchaseOrderReleaseId(null);
        }
        ...
        if (\array_key_exists('purchaseOrderRequestOfferItemId', $data) && $data['purchaseOrderRequestOfferItemId'] !== null) {
            $object->setPurchaseOrderRequestOfferItemId($data['purchaseOrderRequestOfferItemId']);
            unset($data['purchaseOrderRequestOfferItemId']);
        }
        elseif (\array_key_exists('purchaseOrderRequestOfferItemId', $data) && $data['purchaseOrderRequestOfferItemId'] === null) {
            $object->setPurchaseOrderRequestOfferItemId(null);
        }
        if (\array_key_exists('receivedQuantity', $data) && $data['receivedQuantity'] !== null) {
            $object->setReceivedQuantity($data['receivedQuantity']);
            unset($data['receivedQuantity']);
        }
        elseif (\array_key_exists('receivedQuantity', $data) && $data['receivedQuantity'] === null) {
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('batchSerialNumbers') && null !== $data->getBatchSerialNumbers()) {
            $values_2 = [];
        ...
        if ($data->isInitialized('blanketPurchaseOrderId') && null !== $data->getBlanketPurchaseOrderId()) {
