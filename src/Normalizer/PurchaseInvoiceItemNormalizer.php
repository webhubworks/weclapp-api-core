...
class PurchaseInvoiceItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('purchaseInvoiceItemRelationships', $data) && $data['purchaseInvoiceItemRelationships'] !== null) {
            $values_3 = [];
            foreach ($data['purchaseInvoiceItemRelationships'] as $value_3) {
            ...
            $object->setPurchaseInvoiceItemRelationships($values_3);
            unset($data['purchaseInvoiceItemRelationships']);
        }
        elseif (\array_key_exists('purchaseInvoiceItemRelationships', $data) && $data['purchaseInvoiceItemRelationships'] === null) {
            $object->setPurchaseInvoiceItemRelationships(null);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('purchaseInvoiceItemRelationships') && null !== $data->getPurchaseInvoiceItemRelationships()) {
            $values_3 = [];
            foreach ($data->getPurchaseInvoiceItemRelationships() as $value_3) {
                $values_3[] = $this->normalizer->normalize($value_3, 'json', $context);
            }
            $dataArray['purchaseInvoiceItemRelationships'] = $values_3;
        }
