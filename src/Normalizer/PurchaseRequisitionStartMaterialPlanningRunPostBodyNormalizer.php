...
class PurchaseRequisitionStartMaterialPlanningRunPostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('warehouseIds', $data) && $data['warehouseIds'] !== null) {
            $values = [];
        ...
        elseif (\array_key_exists('warehouseIds', $data) && $data['warehouseIds'] === null) {
            $object->setWarehouseIds(null);
        }
    ...
    {
        $dataArray = [];
        if ($data->isInitialized('warehouseIds') && null !== $data->getWarehouseIds()) {
            $values = [];
