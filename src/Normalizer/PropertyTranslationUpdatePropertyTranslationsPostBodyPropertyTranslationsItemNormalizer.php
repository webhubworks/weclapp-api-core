...
class PropertyTranslationUpdatePropertyTranslationsPostBodyPropertyTranslationsItemNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
