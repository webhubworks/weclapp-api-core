...
class ShipmentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('mainSalesOrderId', $data) && $data['mainSalesOrderId'] !== null) {
            $object->setMainSalesOrderId($data['mainSalesOrderId']);
            unset($data['mainSalesOrderId']);
        }
        elseif (\array_key_exists('mainSalesOrderId', $data) && $data['mainSalesOrderId'] === null) {
            $object->setMainSalesOrderId(null);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('mainSalesOrderId') && null !== $data->getMainSalesOrderId()) {
            $dataArray['mainSalesOrderId'] = $data->getMainSalesOrderId();
        }
        ...
        if ($data->isInitialized('shipmentItems') && null !== $data->getShipmentItems()) {
            $values_3 = [];
            foreach ($data->getShipmentItems() as $value_3) {
                $values_3[] = $this->normalizer->normalize($value_3, 'json', $context);
            }
            $dataArray['shipmentItems'] = $values_3;
        }
