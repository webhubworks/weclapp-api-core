...
class ProductionWorkScheduleNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('workScheduleItems', $data) && $data['workScheduleItems'] !== null) {
            $values_1 = [];
        ...
        elseif (\array_key_exists('workScheduleItems', $data) && $data['workScheduleItems'] === null) {
            $object->setWorkScheduleItems(null);
        }
        if (\array_key_exists('workScheduleNumber', $data) && $data['workScheduleNumber'] !== null) {
            $object->setWorkScheduleNumber($data['workScheduleNumber']);
            unset($data['workScheduleNumber']);
        }
        elseif (\array_key_exists('workScheduleNumber', $data) && $data['workScheduleNumber'] === null) {
            $object->setWorkScheduleNumber(null);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('workScheduleItems') && null !== $data->getWorkScheduleItems()) {
            $values_1 = [];
        ...
        if ($data->isInitialized('workScheduleNumber') && null !== $data->getWorkScheduleNumber()) {
